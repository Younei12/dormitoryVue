  ...
  <div class="page-container">
    <section class="flex offset-fotm-item">
      ...
      <div class="margin-left-auto">
        <el-button @click="showAddAdmin" size="medium" type="primary">新增管理员</el-button>
      </div>
    </section>

    <el-table :data="list"
              :default-sort="{prop: 'admin_account', order: 'ascending'}"
              border
              class="margin-top-20"
              stripe>
      <el-table-column align="center" label="账号" prop="admin_account" sortable/>
      ...
      <!--      <el-button @click="editAdmin(scope.row)" circle icon="el-icon-edit font-size-16" plain size="mini"/>-->
      <!--    </el-tooltip>-->
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      <template #footer>
        <div class="text-center">
          ...
          <el-button @click="isShowAddAdmin = false">取消</el-button>
        </div>
      </template>
    </el-dialog>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        request.post('/api/admin/searchAdmin', form).then(res => {
      ...
      async submitAddForm() {
        try {
          ...
          this.request.post('/api/admin/insertOne', this.addForm).then(res => {
            if (!res.data.errcode) {
